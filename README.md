...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/des-sxdes-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12045&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/des-sxdes-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `des-sxdes` can be installed with:

```
conda install des-sxdes
```

It is possible to list all of the versions of `des-sxdes` available on your platform with:
